...
def prepare_val_data(graphs, args, val_idx, max_nodes=0):
    ...
    # minibatch
    dataset_sampler = GraphSampler(train_graphs, args=args, normalize=False, max_num_nodes=max_nodes,
    ...
    dataset_sampler = GraphSampler(val_graphs, args=args, normalize=False, max_num_nodes=max_nodes,
            features=args.feature_type)
